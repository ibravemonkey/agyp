...
`agyp` — это расширенный инструмент и менеджер профилей для `agyp`. Он обеспечивает бесшовное переключение профилей, мониторинг квот нескольких аккаунтов Google (5-часовых и недельных), песочницу без загрязнения глобальной системы, а также статусную строку с отслеживанием веток Git, жизненного цикла AI-агентов и системных звуковых уведомлений.
...
├── scripts/                 # Вспомогательные скрипты (agyq, agyp-sync, notify-sound)
